describe('memoizedRestaurantsApi', function () {
    ...
    describe('getRestaurantsNearConference(cuisine', function () {
        it('기대 인자를 넘겨 api의 getRestaurantsNearConference', function () {
            var cuisine = '분식';
        ...
        it('서드파티 API의 반환값을 확인한다.', function () {
            spyOn(api, 'getRestaurantsNearConference')
        ...
        it('같은 요리를 여러번 요청해도 같은 값으로 귀결한다', function () {
            var cuisine = '한정식';

            return spyOn(api, 'getRestaurantsNearConference')
                .and.returnValue(returnedFromService);
